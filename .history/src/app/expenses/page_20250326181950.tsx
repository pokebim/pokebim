...
export default function ExpensesPage() {
  ...
  const stats = useMemo(() => {
    ...
    // Ahora también considera los ingresos asignados a Biel
    const balanceEquitativo = {
      ...
      biel: parteEquitativa - netByPerson.biel - salesAttribution.biel // Biel ya recibió los ingresos, así que se resta del balance
    };

    // Distribución equitativa del beneficio (se divide entre 3)
    const beneficioEquitativo = netBeneficio / 3;
    
    // Balance final teniendo en cuenta beneficios
    const balanceFinal = {
      edmon: balanceEquitativo.edmon - beneficioEquitativo, // Resta porque es lo que debe recibir como beneficio
      albert: balanceEquitativo.albert - beneficioEquitativo,
      biel: balanceEquitativo.biel + (beneficioEquitativo * 2), // Biel ya tiene su parte + las otras 2 partes
    };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-gray-800 p-4 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-gray-400 mb-1 text-sm">Total Ventas</h3>
            ...
            <div className="bg-gray-800 p-4 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-gray-400 mb-1 text-sm">Beneficios</h3>
