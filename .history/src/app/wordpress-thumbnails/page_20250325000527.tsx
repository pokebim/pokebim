...
export default function WordpressThumbnailsPage() {
  ...
  const processImage = async (fileId: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/wordpress-thumbnails?size=${selectedSize}&fit=${fitMode}&bg=${bgColor}`, {
        method: 'POST',
        body: formData,
      });
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`relative flex items-center justify-center px-3 py-2 text-sm font-medium rounded-md ${
                          bgColor === 'white'
                            ? 'bg-green-700 text-white'
                            : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                        }`}
                      >
                        <span className="inline-block w-4 h-4 bg-white border border-gray-300 rounded-sm mr-1"></span>
                        Blanco
                      </button>
                      <button
                      ...
                      >
                        <span className="inline-block w-4 h-4 bg-black border border-gray-300 rounded-sm mr-1"></span>
                        Negro
                      </button>
                      <button
                      ...
                      >
                        <span className="inline-block w-4 h-4 bg-transparent border border-gray-300 rounded-sm mr-1 relative">
